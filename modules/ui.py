    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    width = gr.Slider(minimum=64, maximum=3840, step=64, label="Width", value=512)
                    height = gr.Slider(minimum=64, maximum=2160, step=64, label="Height", value=512)
    ...
    with gr.Blocks(analytics_enabled=False) as img2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    width = gr.Slider(minimum=64, maximum=3840, step=64, label="Width", value=512, elem_id="img2img_width")
                    height = gr.Slider(minimum=64, maximum=2160, step=64, label="Height", value=512, elem_id="img2img_height")
